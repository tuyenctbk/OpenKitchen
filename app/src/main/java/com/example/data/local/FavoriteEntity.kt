...
/**
 * Room database entity for the dedicated 'Favorites' table, allowing offline bookmarking and retrieval.
 */
...
data class FavoriteEntity(
    ...
    companion object {
        fun fromRecipe(recipe: Recipe, notes: String = ""): FavoriteEntity {
